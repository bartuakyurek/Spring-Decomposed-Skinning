...
class Spring:
    def __init__(self, connection_coord, rest_vector=np.array([1.,0.,0.]), mass=0.1, stiffness=0.4, damper=-0.02):
        self.step = 0.0
        self.dt = 1./24.
    ...
    def update_connection(self, new_connection_coord):
        ...
        self.mass_coord = self.connection_coord + self.rest_vector
        
    
    def simulate(self):
     
        delta_x = self.mass_coord - self.mass_rest_coord
