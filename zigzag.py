...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 15:51:29 2024

Generate a zigzag line that will be utilized to draw springs on the renderer.

TODO: We need a better get_perpendicular() function that can return a vector
that is on the same plane passing through the input vector. Though this is
just for decorative purposes so it's left for a future extension.
